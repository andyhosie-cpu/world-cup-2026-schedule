/**
 * GET /api/outrights
 * Returns the tournament-winner outright market sorted by best (lowest) decimal
 * price across UK bookmakers - favourites first.
 *
...
function aggregateBest(eventList) {
  ...
  // For each team name, find the LOWEST price across bookmakers (favourite
  // price). Outright odds: lower = stronger favourite.
  const byTeam = {};
